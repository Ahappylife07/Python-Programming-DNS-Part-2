...
encrypted_value_str = encrypted_value.decode('utf-8')  # Convert bytes to string for storage
...
dns_records = {
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (str(encrypted_value),),  # Store encrypted token as string
    },
}
